  ...
  return (
    <div style={{ minHeight: '100vh', width: '100%' }} className='d-flex justify-content-center align-items-center bg-dark'>
      <div style={{ width: '600px' }} className='bg-light rounded p-5'>
        <h3>Simple Interest Calculator App</h3>
        <p>Calculate your Simple Interest Easily</p>
        <div className='d-flex flex-column justify-content-center align-items-center bg-info shadow p-3 rounded'>
          <h1> ₹ {interest}</h1>
        ...
        <form className="mt-5">
          ...
          <div className='mb-3'>
            <TextField value={rate || ""} onChange={e => validateInput(e.target)} name='rate' id="outlined-basic1" className='w-100' label="Rate of Interesr (p.a) %" variant="outlined" />
          </div>
          {
            isRateInvalid &&
          ...
          <div className='mb-3'>
            <TextField value={year || ""} onChange={e => validateInput(e.target)} name='year' id="outlined-basic2" className='w-100' label="Time Period (Year)" variant="outlined" />
          </div>
          {
            isYearInvalid &&
          ...
          <Stack direction="row" spacing={2}>
            ...
            <Button style={{ width: '50%', height: '70px' }} className='bg-dark' variant="contained" onClick={resetCalculate}>Reset</Button>
          </Stack>
        </form>
      </div>
    </div>
